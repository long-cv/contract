...
contract TokenERC20 is ERC20Detailed, ERC20Pausable, ERC20Mintable {
    ...
    function transferFrom(address from, address to, uint256 value) public override(ERC20, ERC20Pausable) returns (bool) {
        return super.transferFrom(from, to, value);
    }

    function approve(address spender, uint256 value) public override(ERC20, ERC20Pausable) returns (bool) {
        return super.approve(spender, value);
    }
